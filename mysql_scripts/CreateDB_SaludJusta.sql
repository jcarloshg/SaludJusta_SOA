...
INSERT INTO User (name, lastName, phoneNumber, age, gender, email, password , role)
values
	('Jose Carlos', 'Huerta', '522212272775', 18, 'FAMALE', 'carlosj12336@gmail.com', 'jose123', 'CLIENT' ),
	('Christian', 'Pasten', '521234567890', 18,'FAMALE', 'christian@email.com', 'christian123', 'CLIENT' ),
	('Luis David', 'Hernandez', '521234567890', 24, 'MALE', 'luis@email.com', 'luis123', 'RECEPTIONIST' ),
	('Emmanuel', 'Bazan Velazco', '521234567890', 45, 'MALE', 'emmanuel@email.com', 'emmanuel123', 'RECEPTIONIST' ),
	('Richie', 'Buena Vibra', '521234567890', 62, 'FAMALE', 'richie@email.com', 'richie123', 'LAB_TECHNICIAN' ),
	('Alejando', 'Buena Cara', '521234567890', 25, 'MALE', 'alejando@email.com', 'alejandro123', 'LAB_TECHNICIAN' )
;
...
values
  ...
  ('2022-04-22', '08:00:00', "NO ASIGNADA", 1),
  ('2022-04-22', '08:30:00', "NO ASIGNADA", 1),
  ('2022-04-23', '09:00:00', "NO ASIGNADA", 1),
  ('2022-04-23', '09:30:00', "NO ASIGNADA", 1),
  #############
  ('2022-04-21', '07:00:00', "NO ASIGNADA", 2),
  ('2022-04-21', '08:00:00', "NO ASIGNADA", 2),
  ('2022-04-22', '09:00:00', "NO ASIGNADA", 2),
  ('2022-04-22', '10:00:00', "NO ASIGNADA", 2),
  ('2022-04-23', '11:00:00', "NO ASIGNADA", 2),
  ('2022-04-23', '12:00:00', "NO ASIGNADA", 2),
  #############
  ('2022-04-21', '12:00:00', "NO ASIGNADA", 3),
  ('2022-04-21', '12:30:00', "NO ASIGNADA", 3),
  ('2022-04-22', '13:00:00', "NO ASIGNADA", 3),
  ('2022-04-22', '13:30:00', "NO ASIGNADA", 3),
  ('2022-04-23', '14:00:00', "NO ASIGNADA", 3),
  ('2022-04-23', '14:30:00', "NO ASIGNADA", 3),
  #############
  ('2022-04-21', '12:00:00', "NO ASIGNADA", 4),
  ('2022-04-21', '13:00:00', "NO ASIGNADA", 4),
  ('2022-04-22', '14:00:00', "NO ASIGNADA", 4),
  ('2022-04-22', '15:00:00', "NO ASIGNADA", 4),
  ('2022-04-23', '16:00:00', "NO ASIGNADA", 4),
  ('2022-04-23', '17:00:00', "NO ASIGNADA", 4),
  #############
  ('2022-04-21', '07:00:00', "NO ASIGNADA", 5),
  ('2022-04-21', '08:00:00', "NO ASIGNADA", 5),
  ('2022-04-22', '08:00:00', "NO ASIGNADA", 5),
  ('2022-04-22', '09:00:00', "NO ASIGNADA", 5),
  ('2022-04-23', '10:00:00', "NO ASIGNADA", 5),
  ('2022-04-23', '11:00:00', "NO ASIGNADA", 5)
  ;
